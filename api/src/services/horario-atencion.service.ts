...
import { horaCRaUTC } from "../utils/timezone";
...
export const horarioAtencionService = {
    ...
    async crear(
        ...
        // horaInicio y horaFin deben venir como string "HH:mm" desde React
        const horaInicioUTC = horaCRaUTC(horaInicio);
        const horaFinUTC = horaCRaUTC(horaFin);
